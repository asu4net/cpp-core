...
prj_game ("01_quads", "examples/01_quads") 
prj_game ("02_textures", "examples/02_textures") 
prj_game ("03_batch_rendering_2d", "examples/03_batch_rendering_2d") 
prj_game ("pong", "games/pong") 
prj_game ("survive2d", "games/survive2d") 